{
    ...
    'data': [
        ...
        'templates/templates_jep.xml',
        'templates/sigestic_template.xml',
        'templates/metrologia_template.xml',
        'templates/desoft_template.xml',
        ...
        #'data/type_attendee_registration_groups.xml',
