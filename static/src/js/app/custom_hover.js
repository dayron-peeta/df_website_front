        ...
        $.ajax({
            ...
            if (result.length > 0) {
                result.forEach(function (item, i) {
                    ...
                    if (item.video_track_external != '' && item.video_track_external != undefined && item.video_track_external != 'undefined') {
                        url = item.video_track_external;
                        target_blank = true;
                    } else if (item.event_area_id != '' && item.event_area_id != undefined && item.event_area_id != 'undefined') {
